...
- Create a folder to clone the repo: `mkdir -p ~/MSCCAM`
- Go into the folder: `cd ~/MSCCAM`
...
On your JetStream2 instance, you can look at the available modules with `module avail`
For this specific workflow we need conda or similar ones, load the Miniforge module: `module load miniforge/24.7.1-0`
